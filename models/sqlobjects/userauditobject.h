#ifndef USERAUDITOBJECT_H
#define USERAUDITOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT UserAuditObject : public TSqlObject, public QSharedData
{
public:
    int id {0};
    QString created_at;
    ...
    QString tableName() const override { return QLatin1String("UserAudit"); }
...
private:    /*** Don't modify below this line ***/
    ...
    Q_PROPERTY(int user READ getuser WRITE setuser)
    T_DEFINE_PROPERTY(int, user)
